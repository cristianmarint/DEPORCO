            ...
            <div class="bg-white has-shadow">
                ...
                <form action="{{route('temporadas.update', $temporada->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input id="create_inicio" type="text" name="fecha_inicio" class="date form-control{{ $errors->has('fecha_inicio') ? ' is-invalid' : '' }}" value="{{$temporada->fecha_fin}}" placeholder="Ingrese la fecha de inicio">
