    ...
    <div class="card-body">
        <form action="{{route('enfrentamientos.update', $enfrentamiento->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                <input id="resultado_local" type="number" name="resultado_local" class="form-control{{ $errors->has('resultado_local') ? ' is-invalid' : '' }} text-center " value="{{$enfrentamiento->resultado->resultado_local}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-3">
                    <input id="resultado_visitante" type="number" name="resultado_visitante" class="form-control{{ $errors->has('resultado_visitante') ? ' is-invalid' : '' }}  text-center" value="{{$enfrentamiento->resultado->resultado_visitante}}" >
